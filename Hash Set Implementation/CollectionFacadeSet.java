...
public class CollectionFacadeSet implements SimpleSet{
    ...
    public CollectionFacadeSet(Collection<String> collection){
        ...
        TreeSet<String> oldSet = new TreeSet<>(collection);
        collection.clear();
        collection.addAll(oldSet);
    ...
    public boolean add(String newValue){
        return !theCollection.contains(newValue) && theCollection.add(newValue);
    }
    ...
    public boolean contains(String searchVal){
        return theCollection.contains(searchVal);
    }
    ...
    public boolean delete(String toDelete){
        return theCollection.remove(toDelete);
    }
